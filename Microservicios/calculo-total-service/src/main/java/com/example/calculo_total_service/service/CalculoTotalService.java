package com.example.calculo_total_service.service;

import com.example.calculo_total_service.entity.CalculoTotal;
import com.example.calculo_total_service.model.Credito;
import com.example.calculo_total_service.model.Usuario;
import com.example.calculo_total_service.repository.CalculoTotalRepository;
...
public class CalculoTotalService {
        ...
        @Autowired
        CalculoTotalRepository calculoTotalRepository;

        RestTemplate restTemplate;

        public List<CalculoTotal> getAll() {
                return calculoTotalRepository.findAll();
        }

        public CalculoTotal getCalculoTotalById(int id) {
                return calculoTotalRepository.findById(id).orElse(null);
        }

        public CalculoTotal saveCalculoTotal(CalculoTotal calculoTotal) {
                CalculoTotal calculoTotalNew = calculoTotalRepository.save(calculoTotal);
                return calculoTotalNew;
        }

        public void deleteCalculoTotal(int id) {
                calculoTotalRepository.deleteById(id);
        }

        public List<CalculoTotal> byUsuarioId(int usuarioId) {
                return calculoTotalRepository.findByUsuarioId(usuarioId);
        }
